...
export const MESSAGES: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'deco.carveThrough': 'Découpe traversante (mode vectoriel)',
    'deco.carveThrough.hint': 'Le motif SVG devient un VRAI trou à travers le panneau (laser/CNC-ready). STL watertight. Uniquement mode vectoriel sur murs — ignoré pour heightmap et panneaux de toit.',
  ...
  en: {
    ...
    'deco.carveThrough': 'Through-cut (vector mode)',
    'deco.carveThrough.hint': 'The SVG pattern becomes a REAL hole through the panel (laser/CNC-ready). Watertight STL. Vector mode only on walls — ignored for heightmap and roof panels.',
    'deco.clip': '▸ CLIPPING',
